...
export const PortalBookPage = () => {
  ...
  const services = mockProducts.filter(p => p.category === 'Service');
  const staff = [
    { id: '1', name: 'Alex Thompson', role: 'Senior Barber', avatar: 'AT' },
    { id: '2', name: 'Jessica Lee', role: 'Stylist', avatar: 'JL' },
    { id: '3', name: 'Sam Wilson', role: 'Junior Barber', avatar: 'SW' },
  ];
                 ...
                 <CardContent className="p-5 flex items-center justify-between">
                   <div className="flex items-center gap-4">
                     ...
                     <div>
                       ...
                       <p className="text-xs text-muted-foreground">45 mins • Skilled professional</p>
                     </div>
                   </div>
